...
import { BuyerHotelExhibitorRepository } from '@core/buyerHotelExhibitor/infra/repositories';
...
container.registerSingleton<IBuyerHotelExhibitorRepository>(
  'BuyerHotelExhibitorRepository',
  BuyerHotelExhibitorRepository
);
