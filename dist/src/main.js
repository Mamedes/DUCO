...
const GetAppointment_1 = __importDefault(require("./core/usecase/GetAppointment"));
...
class Main {
    ...
    generateExhibitors() {
        const exhibitors = new exhibitors_1.default(this.TOTAL_EXHIBITOR);
        this.listOfExhibitors = exhibitors.exhibitorsGenerated;
    }
    generateBuyers() {
        const buyers = new buyers_1.default(this.TOTAL_BUYERS);
