...
const main_1 = __importDefault(require("../src/core/usecase/main"));
...
test("Should generate event list", async () => {
    const eventList = new main_1.default(TOTAL_BUYERS, TOTAL_EXHIBITOR, hotels, hotels.length, TOTAL_DAYS, TOTAL_EVENTS_DAY);
